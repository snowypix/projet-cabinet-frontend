        ...
        <>
            ...
            <div className="max-w-sm mx-auto my-10 p-6 border border-gray-300 rounded">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <input type="text" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
